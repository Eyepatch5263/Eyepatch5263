...
- Building responsive and engaging UIs
- Designing scalable web applications using the **MERN** stack and **Next.js**
- Writing blogs about technology and books I read
...
1. **Chatie**
   - A feature-rich chat application with secure authentication, image and video sharing, and a sleek UI.

2. **Eyengl**
   - An anonymous confession platform powered by AI, offering a secure and interactive experience.

3. **Onlyanime**
   - An e-commerce platform for anime enthusiasts, integrated with an admin panel for efficient management.

4. **Codilio**
   - A coding environment supporting multiple programming languages using the Piston API.

---

## 🌱 Learning Goals for 2025

- Dive deeper into **Docker**, **Kubernetes**, and **AWS**
- Explore **CI/CD pipelines** for efficient deployment
- Master advanced **Next.js** features and performance optimization
...
Feel free to check out my repositories and don't hesitate to reach out for collaborations or discussions on tech, UI/UX, and DevOps. Let's create something amazing together! 🚀
...
[![Eyepatch github activity graph](https://github-readme-activity-graph.vercel.app/graph?username=Eyepatch5263&theme=react-dark&hide_border=true&area=true)](https://github.com/ashutosh00710/github-readme-activity-graph)
